...
public class DrawTextPanel extends JPanel  {
	...
	//Changing to an ArrayList	
	private ArrayList<DrawTextItem> listOfItems = new ArrayList<DrawTextItem>();
	...
	public DrawTextPanel() {
		...
		input = new JTextField("Type your text here!", 40);
		bottom.add(input);
	...
	public void doMousePress( MouseEvent e ) {
		...
		if (text.length() == 0) {
			input.setText("Type your text here!");
		...
		try {
			...
			JOptionPane.showMessageDialog(this, "Angle must be a valid int number.");
			return;
		}
